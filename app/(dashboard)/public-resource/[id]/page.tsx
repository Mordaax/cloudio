...
import { GetCloudResourceWithLogEntrys, GetPublicCloudResourceById } from "@/actions/formCloudResourceAction";
...
async function FormDetailPage({
  ...
  const { id } = params;
  const form = await GetPublicCloudResourceById(String(id));
  if (!form) {
 ...
 */
  ...
  <div className="mt-1 container">
    ...
    <div className="py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
        <dt className="text-sm font-medium leading-6 ">Connect</dt>
            ...
            <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
              <div className="flex w-0 flex-1 items-center">
                ...
                <div className="ml-4 flex min-w-0 flex-1 gap-2">
                  ...
                  <span className="truncate font-medium">openvpn client.ovpn</span>
                </div>
              ...
              <div className="ml-4 flex-shrink-0">
                ...
                <a download="client.ovpn" target="_blank" rel="noreferrer" href="https://storage.googleapis.com/cloudiobucket/client.ovpn" className="font-medium text-indigo-600 hover:text-indigo-500">Download</a>
              </div>
            </li>
